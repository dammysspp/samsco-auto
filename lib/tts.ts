 ...
 */
export async function generateFreeSpeech(text: string, id: string): Promise<string> {
  try {
    ...
    if (!cleanedText) {
      throw new Error("No pronounceable text remaining in script after filtering cues.");
    }
    ...
    // 5. Ensure output directory exists in Next.js public directory
    ...
    console.log(`[TTS API] Voiceover generated successfully: /audio/${filename}`);
