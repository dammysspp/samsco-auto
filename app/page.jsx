  ...
  const features = [
    {
      ...
      description:
        "Parses ESPN and Sky Sports RSS feeds dynamically, extracting the latest updates from the 2026 FIFA World Cup matches.",
      icon: RefreshCw,
    ...
    },
    {
      ...
      description:
        "Writes engaging YouTube Shorts scripts (hooks and timestamps) and poll-style Community posts in seconds.",
      icon: Cpu,
    ...
    },
    {
      ...
      description:
        "Integrates with YouTube Data API v3, managing upload streams, categories, tags, and description parameters.",
      icon: Youtube,
    ...
    },
    {
      ...
      description:
        "Utilizes Vercel Cron jobs and Prisma PostgreSQL to run hourly background checks and dispatch videos.",
      icon: Clock,
    ...
    <div className="bg-zinc-950 min-h-screen text-zinc-100 flex flex-col justify-between selection:bg-emerald-500 selection:text-white font-sans">
      ...
      <main className="max-w-7xl mx-auto w-full px-6 py-12 flex flex-col lg:flex-row items-center justify-between gap-12 relative z-10 flex-grow">
        ...
        <div className="flex-1 space-y-6 max-w-xl text-center lg:text-left">
          ...
          <h1 className="text-4xl md:text-5xl font-extrabold tracking-tight text-zinc-100 leading-tight">
            Automated Football Content{" "}
            <span className="text-emerald-400 bg-gradient-to-r from-emerald-400 to-teal-400 bg-clip-text text-transparent">
              Powerhouse
            </span>
          </h1>
          <p className="text-zinc-400 text-sm leading-relaxed">
            Ingest live match results, generate high-retention YouTube Shorts
            scripts, build community tab engagement polls via Groq Llama-3-70b,
            and automate posting schedules with Vercel Cron.
          </p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-left pt-4">
            {features.map((feat) => {
              ...
              return (
                <div
                  key={feat.title}
                  className={`p-4 rounded-xl border ${feat.color} bg-zinc-900/10 space-y-1.5`}
                >
        ...
        <div className="w-full max-w-md p-8 rounded-2xl border border-zinc-800 bg-zinc-950/60 backdrop-blur-md flex flex-col items-center justify-center space-y-6 relative shadow-2xl">
          ...
          <div className="text-center space-y-2">
            ...
            <p className="text-xs text-zinc-500">
              Lock down your credentials and publication pipelines securely.
            </p>
          </div>
          ...
          <p className="text-[9px] text-zinc-600 text-center max-w-xs leading-normal">
            By signing in, you connect your workspace to your local Prisma
            PostgreSQL instance.
          </p>
        </div>
      </main>
      ...
      <footer className="border-t border-zinc-900 relative z-10">
        <div className="max-w-7xl mx-auto px-6 py-6 flex flex-col sm:flex-row justify-between items-center text-[10px] text-zinc-500 gap-4">
          <span>
            &copy; 2026 Football Content Pipeline. All rights reserved.
          </span>
